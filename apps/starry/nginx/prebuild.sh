...
install -Dm0755 "$app_dir/stress/nginx-stress-s0-baseline.sh" "$overlay_dir/usr/bin/nginx-stress-s0-baseline.sh"
install -Dm0755 "$app_dir/stress/nginx-stress-s1-short-conn.sh" "$overlay_dir/usr/bin/nginx-stress-s1-short-conn.sh"
install -Dm0755 "$app_dir/stress/nginx-stress-s2-keepalive.sh" "$overlay_dir/usr/bin/nginx-stress-s2-keepalive.sh"
